...
function Welcome() {
  return (
   <div className='p-4 m-8  flex flex-col items-center justify-center'>
    <h1 className='text-3xl text-white mb-4'>Welcome to the weather app <span className='font-semibold text-yellow-300'> ipgautomotive</span></h1>
   ...
   {/* <p className='p-2 m-2' >Get real-time forecasts, detailed insights, and plan your day with confidence!</p> */}
