...
function Welcome() {
  return (
    <div className="p-4 m-2  flex flex-col items-center justify-center">
      <img src="ipg.png" alt="ipg logo" className="self-start mb-[-1%] h-8" />
      <h1 className="text-3xl text-white mb-4">
        Welcome to the weather app
        <span className="gradientText font-semibold text-transparent bg-clip-text ">
          ipgautomotive
        </span>
      </h1>

      {/*-----------< sun svg >------------*/}
      <h1 className="text-8xl text-center text-white font-bold w-[90%] ">
        ...
        <span>
          ...
          <span className="ml-24">RECAST</span>
        </span>
      </h1>
